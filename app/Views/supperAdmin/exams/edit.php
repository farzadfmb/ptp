...
$exam = $exam ?? [];
$examConfig = $exam['config_data'] ?? [];

$formatDateTimeForInput = function ($value) {
    if (!$value) {
        return '';
    }
...
$selectedExamType = old('exam_type', $exam['type'] ?? $defaultExamType);
...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-body">
        <div class="row gy-4">
                ...
                <div class="card">
                    <div class="card-body pb-0 text-end">
                        <div class="mb-16">
                            ...
                            <p class="text-gray-500 mb-0">در این بخش می‌توانید اطلاعات آزمون انتخاب شده را ویرایش کنید.</p>
                        </div>
            ...
            <div class="col-12">
                <form action="<?= UtilityHelper::baseUrl('supperadmin/exams/update'); ?>" method="post" class="card" novalidate>
                    <div class="card-body text-end">
                        ...
                        <div class="mb-20">
                            ...
                            <p class="text-13 text-gray-500 mb-0">عنوان، توضیحات و بازه زمانی آزمون را به‌روزرسانی کنید.</p>
                        </div>

                        <div class="row g-16">
                            <div class="col-lg-6">
                                <label class="form-label fw-semibold text-end d-block">عنوان آزمون <span class="text-danger">*</span></label>
                                <input type="text" name="title" class="form-control" value="<?= htmlspecialchars(old('title', $exam['title'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="عنوان آزمون" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control" rows="4" placeholder="شرح کوتاه از اهداف آزمون."><?= htmlspecialchars(old('description', $exam['description'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                        ...
                        <div class="row g-16">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <input type="datetime-local" name="start_at" class="form-control" value="<?= htmlspecialchars(old('start_at', $formatDateTimeForInput($exam['start_at'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <input type="datetime-local" name="end_at" class="form-control" value="<?= htmlspecialchars(old('end_at', $formatDateTimeForInput($exam['end_at'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <input type="number" name="passing_score" class="form-control" min="0" max="100" step="0.1" value="<?= htmlspecialchars(old('passing_score', $exam['passing_score'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: ۷۰">
                                ...
                                <div class="exam-type-fields border rounded-16 p-20 mb-24 <?= $selectedExamType === $typeKey ? '' : 'd-none'; ?>" data-exam-type="<?= $typeKey; ?>">
                                    ...
                                    <div class="row g-16">
                                        <?php foreach ($fields as $field):
                                            ...
                                            $configValue = $examConfig[$fieldName] ?? null;
                                            $value = old($fieldName, $configValue !== null ? $configValue : $fieldDefault);
