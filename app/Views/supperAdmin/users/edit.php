...
$selectedRoleId = old('role_id', (string) ($userData['role_id'] ?? ''));
...
<div class="dashboard-main-wrapper" dir="rtl">
    ...
    <div class="dashboard-body">
        <div class="row gy-4">
                    ...
                    <div class="card-body text-end">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-12 mb-20">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 mb-0">اطلاعات کاربر را به‌روزرسانی کنید. در صورت عدم تغییر رمز عبور، این فیلدها را خالی بگذارید.</p>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <form action="<?= UtilityHelper::baseUrl('supperadmin/users/update'); ?>" method="post" class="card">
                    <div class="card-body text-end">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="user_id" value="<?= (int) ($userData['id'] ?? 0); ?>">

                        <div class="row g-16">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">نام <span class="text-danger">*</span></label>
                                <input type="text" name="first_name" class="form-control" value="<?= htmlspecialchars(old('first_name', $userData['first_name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: علی" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="last_name" class="form-control" value="<?= htmlspecialchars(old('last_name', $userData['last_name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: محمدی" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control" value="<?= htmlspecialchars(old('email', $userData['email'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: user@example.com" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mobile" class="form-control" value="<?= htmlspecialchars(old('mobile', $userData['mobile'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: 09121234567">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="national_code" class="form-control" value="<?= htmlspecialchars(old('national_code', $userData['national_code'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: 1234567890" maxlength="10">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php $selectedStatus = old('status', $userData['status'] ?? 'active'); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="organization_id" id="organizationSelect" class="form-select" <?= $requiresOrganization ? 'required' : ''; ?> data-requires-org="<?= $requiresOrganization ? '1' : '0'; ?>">
                                    ...
                                    <?php foreach ($organizations as $organization): ?>
                                        <option value="<?= (int) $organization['id']; ?>" <?= (string) old('organization_id', $userData['organization_id'] ?? '') === (string) $organization['id'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php else: ?>
                                    <small class="text-gray-500 d-block mt-6">برای حفظ رمز عبور فعلی، این فیلد را خالی بگذارید.</small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
    ...
    (function() {
        ...
        const toggleOrganizationRequirement = () => {
            ...
            if (isOrganizationRole) {
                ...
                if (organizationSelect.dataset.requiresOrg !== '1') {
