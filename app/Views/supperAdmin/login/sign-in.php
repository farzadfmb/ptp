...
<section class="auth d-flex flex-row-reverse">
    <div class="auth-left bg-main-50 flex-center p-24">
        <img src="<?= htmlspecialchars($rightIllustrationUrl, ENT_QUOTES, 'UTF-8'); ?>" alt="سوپر ادمین" style="max-width: 100%; height: auto;">
    </div>
    <div class="auth-right py-40 px-24 flex-center flex-column" dir="rtl">
        <div class="auth-right__inner mx-auto w-100" style="max-width: 440px;">
            ...
            <p class="text-gray-600 text-15 mb-32">برای ورود به پنل سوپر ادمین، اطلاعات حساب خود را وارد کنید.</p>
            ...
            <form action="<?= UtilityHelper::baseUrl('supperadmin/login'); ?>" method="post" class="text-end">
                <?= csrf_field(); ?>
                <div class="mb-24">
                    <label for="identifier" class="form-label mb-8 h6">ایمیل</label>
                    <div class="position-relative">
                        <input type="text" name="email" class="form-control py-11 ps-40" id="identifier" placeholder="example@domain.com" value="<?= htmlspecialchars(old('email', $oldInput['email'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" required>
                ...
                <div class="mb-32 flex-between flex-wrap gap-8">
                    ...
                    <a href="<?= UtilityHelper::baseUrl('supperadmin/password/forgot'); ?>" class="text-main-600 hover-text-decoration-underline text-15 fw-medium">فراموشی رمز عبور</a>
                </div>
                <button type="submit" class="btn btn-main rounded-pill w-100">ورود به پنل</button>
            </form>
        </div>
    </div>
</section>
