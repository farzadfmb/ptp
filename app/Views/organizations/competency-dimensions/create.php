                    ...
                    <div class="card-body p-24">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                            <div class="text-start flex-grow-1">
                                <h2 class="mb-6 text-gray-900">ایجاد بعد شایستگی</h2>
                                <p class="text-gray-500 mb-0">اطلاعات بعد جدید را وارد کرده و آن را به لیست اضافه کنید.</p>
                            </div>
                        ...
                        <form action="<?= UtilityHelper::baseUrl('organizations/competency-dimensions'); ?>" method="post" class="competency-dimension-form text-start">
                            <?= csrf_field(); ?>
                            <div class="row g-16">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">نام <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" value="<?= htmlspecialchars(old('name', ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: رهبری" required>
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="form-check form-switch ms-auto">
                                        <?php $isPublicOld = (int) old('is_public', '0') === 1; ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="توضیحات تکمیلی درباره بعد شایستگی"><?= htmlspecialchars(old('description', ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
