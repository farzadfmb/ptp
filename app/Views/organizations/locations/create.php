                    ...
                    <div class="card-body p-24">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                            <div class="text-start flex-grow-1">
                                <h2 class="mb-6 text-gray-900">ایجاد محل خدمت</h2>
                                <p class="text-gray-500 mb-0">فرم زیر را تکمیل کنید تا محل خدمت جدید به لیست افزوده شود.</p>
                            </div>
                        ...
                        <form action="<?= UtilityHelper::baseUrl('organizations/service-locations'); ?>" method="post" class="organization-service-location-form text-start">
                            <?= csrf_field(); ?>
                            <div class="row g-16">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">کد <span class="text-danger">*</span></label>
                                    <input type="text" name="code" class="form-control ltr-input" value="<?= htmlspecialchars(old('code', ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: LOC-01" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?= htmlspecialchars(old('name', ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: اداره مرکزی" required>
