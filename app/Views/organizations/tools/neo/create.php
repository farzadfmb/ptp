...
$title = $title ?? 'افزودن تیپ شخصیتی NEO';
                    ...
                    <div class="card-body p-24">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                            <div class="text-start flex-grow-1">
                                <h2 class="mb-6 text-gray-900">افزودن تیپ شخصیتی NEO</h2>
                                <p class="text-gray-500 mb-0">مشخصات تیپ جدید NEO را وارد کنید تا در آزمون سازمان فعال شود.</p>
                            </div>
