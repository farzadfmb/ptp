...
$title = $title ?? 'افزودن ویژگی تیپ MBTI';
            ...
            <div class="col-12">
                <div class="card card-rounded shadow-sm border-0 p-24">
                    <div class="d-flex flex-wrap justify-content-between align-items-start gap-16 mb-20">
                        <div>
                            <h2 class="mb-6 text-gray-900">افزودن ویژگی جدید برای تیپ MBTI</h2>
                            <p class="text-gray-500 mb-0">برای این تیپ شخصیتی، ویژگی‌های تکمیلی را ثبت کنید.</p>
                        </div>
                    ...
                    <div class="row g-16 mb-24">
                        <div class="col-12 col-lg-4">
                            <div class="bg-gray-50 rounded-20 p-16 h-100">
                                ...
                                <h3 class="text-indigo-900 fw-bold mb-8">
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            <?php
                                $formAction = UtilityHelper::baseUrl('organizations/tools/mbti-settings/features');
                                $submitLabel = 'ثبت ویژگی';
                                $cancelUrl = $backUrl;
                                $isEdit = false;
