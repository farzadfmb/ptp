...
$createdAt = $organizationRole['created_at'] ?? null;
$updatedAt = $organizationRole['updated_at'] ?? null;
...
$inline_styles .= "\n    body {\n        background: #f5f7fb;\n    }\n    .organization-role-form label,\n    .organization-role-form small {\n        text-align: right;\n        display: block;\n    }\n    .organization-role-form .form-control {\n        text-align: right;\n        direction: rtl;\n    }\n    .organization-role-summary {\n        background: #f9fafc;\n    }\n    .organization-role-summary .summary-section + .summary-section {\n        border-top: 1px solid #e5e7eb;\n        margin-top: 16px;\n        padding-top: 16px;\n    }\n    .organization-role-summary dt {\n        color: #6b7280;\n        font-weight: 500;\n    }\n    .organization-role-summary dd {\n        margin: 0;\n        color: #111827;\n        font-weight: 600;\n    }\n";
                    ...
                    <div class="card-body p-24">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                            <div class="text-start flex-grow-1">
                                <h2 class="mb-6 text-gray-900">ویرایش نقش</h2>
                                <p class="text-gray-500 mb-0">مقادیر مورد نظر را اصلاح کرده و تغییرات را ذخیره نمایید.</p>
                            </div>
                            <div class="d-flex gap-10 flex-wrap">
                                <a href="<?= UtilityHelper::baseUrl('organizations/roles'); ?>" class="btn btn-outline-gray rounded-pill px-24 d-flex align-items-center gap-8" title="بازگشت">
                                    بازگشت به لیست
                                    <ion-icon name="arrow-undo-outline"></ion-icon>
                                    <span class="visually-hidden">بازگشت به لیست نقش‌ها</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row g-24 align-items-start">
                            <div class="col-12 col-lg-8">
                                <form action="<?= UtilityHelper::baseUrl('organizations/roles/update'); ?>" method="post" class="organization-role-form text-start">
                                    <?= csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?= htmlspecialchars((string) ($organizationRole['id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">

                                    <div class="row g-16">
                                        <div class="col-12 col-md-6">
                                            <label class="form-label fw-semibold">نام نقش <span class="text-danger">*</span></label>
                                            <input type="text" name="name" class="form-control" value="<?= htmlspecialchars(old('name', $organizationRole['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="مثال: مدیر سیستم" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" class="form-control" rows="4" placeholder="توضیح کوتاه درباره وظایف و مسئولیت‌های این نقش"><?= htmlspecialchars(old('description', $organizationRole['description'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    ...
                                    <div class="d-flex justify-content-end gap-12 mt-28">
                                        ...
                                        <a href="<?= UtilityHelper::baseUrl('organizations/roles'); ?>" class="btn btn-outline-gray rounded-pill px-28">انصراف</a>
                                    </div>
                                </form>
                            </div>
                            <div class="col-12 col-lg-4">
                                <div class="border border-gray-200 rounded-20 p-20 organization-role-summary shadow-sm h-100">
                                    <div class="d-flex justify-content-between align-items-center mb-16">
                                        <h5 class="mb-0 text-gray-900 fw-semibold">خلاصه نقش</h5>
                                    ...
                                    <div class="summary-section">
                                        <dl class="mb-0">
                                            <div class="d-flex justify-content-between align-items-center gap-12 mb-12">
                                                ...
                                                <dd><?= htmlspecialchars(UtilityHelper::englishToPersian((string) ($organizationRole['id'] ?? '—')), ENT_QUOTES, 'UTF-8'); ?></dd>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center gap-12">
                                                <dt class="mb-0">نام نقش</dt>
                                                <dd><?= htmlspecialchars($organizationRole['name'] ?? '—', ENT_QUOTES, 'UTF-8'); ?></dd>
                                            </div>
                                        </dl>
                                    </div>
                                    ...
                                    <div class="summary-section">
                                        <dl class="mb-0">
                                            <div class="d-flex justify-content-between align-items-center gap-12 mb-12">
                                                ...
                                                <dd><?= htmlspecialchars(UtilityHelper::englishToPersian((string) ($organizationRole['organization_id'] ?? '—')), ENT_QUOTES, 'UTF-8'); ?></dd>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center gap-12">
                                                <dt class="mb-0">شناسه کاربر</dt>
                                                <dd><?= htmlspecialchars((string) ($organizationRole['user_id'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></dd>
                                            </div>
                                        </dl>
                                    </div>
                                    ...
                                    <div class="summary-section">
                                        <p class="text-gray-500 mb-0">پس از ذخیره تغییرات، جزئیات جدید در فهرست نقش‌های سازمانی قابل مشاهده خواهد بود.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
