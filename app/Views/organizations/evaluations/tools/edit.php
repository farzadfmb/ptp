...
$title = $title ?? 'ویرایش ابزار ارزیابی';
                ...
                <div class="card border-0 shadow-sm rounded-24 h-100">
                    <div class="card-body p-24">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                            <div>
                                <h2 class="mb-6 text-gray-900">ویرایش ابزار ارزیابی</h2>
                                <p class="text-gray-500 mb-0">اطلاعات ابزار ارزیابی انتخاب‌شده را به‌روزرسانی کنید.</p>
                            </div>
                            <div>
                        ...
                        <form action="<?= UtilityHelper::baseUrl('organizations/evaluation-tools/update'); ?>" method="post" class="evaluation-tool-form">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id" value="<?= htmlspecialchars((string) ($evaluationTool['id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                            <div class="row g-16">
                                <div class="col-md-4">
                                    <label class="form-label">کد <span class="text-danger">*</span></label>
                                    <input type="text" name="code" class="form-control ltr-input" placeholder="مثال: TOOL-01" value="<?= htmlspecialchars(old('code', $evaluationTool['code'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="مثال: پرسشنامه رضایت کارکنان" value="<?= htmlspecialchars(old('name', $evaluationTool['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="question_type" class="form-control" list="question-type-suggestions" placeholder="نوع سوالات، مثال: چندگزینه‌ای" value="<?= htmlspecialchars(old('question_type', $evaluationTool['question_type'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="guide" class="form-control" placeholder="توضیح کوتاه درباره نحوه استفاده از ابزار"><?= htmlspecialchars(old('guide', $evaluationTool['guide'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">توضیح ابزار</label>
                                    <textarea name="description" class="form-control" placeholder="اطلاعات تکمیلی درباره ابزار"><?= htmlspecialchars(old('description', $evaluationTool['description'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">مدت زمان (دقیقه)</label>
                                    <?php
                                        $defaultDuration = $evaluationTool['duration_minutes'] ?? '';
                                        $defaultDuration = $defaultDuration === null ? '' : (string) $defaultDuration;
                                    ?>
                                    <input type="number" name="duration_minutes" class="form-control ltr-input" min="0" placeholder="مثال: 30" value="<?= htmlspecialchars(old('duration_minutes', $defaultDuration), ENT_QUOTES, 'UTF-8'); ?>">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php
                                        $defaultIsExam = isset($evaluationTool['is_exam']) ? (string) $evaluationTool['is_exam'] : '0';
                                        $oldIsExam = (string) old('is_exam', $defaultIsExam);
                                    ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php
                                        $defaultResultOnly = isset($evaluationTool['is_result_only']) ? (string) $evaluationTool['is_result_only'] : '0';
                                        $oldIsResultOnly = (string) old('is_result_only', $defaultResultOnly);
                                    ?>
                                    <div class="form-switch pt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                        $defaultOptional = isset($evaluationTool['is_optional']) ? (string) $evaluationTool['is_optional'] : '0';
                                        $oldIsOptional = (string) old('is_optional', $defaultOptional);
                                    ?>
                                    <div class="form-switch pt-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="calculation_formula" class="form-control" list="calculation-formula-suggestions" placeholder="مثال: MBTI یا NEO" value="<?= htmlspecialchars(old('calculation_formula', $evaluationTool['calculation_formula'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
