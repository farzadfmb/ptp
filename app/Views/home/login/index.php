...
$title = $title ?? 'ورود کاربران سامانه';
...
$rightIllustrationUrl = $rightIllustrationUrl ?? UtilityHelper::baseUrl('public/images/superAdmin/admin-control-panel-illustration-svg-download-png-3722637.png');
...
<section class="auth d-flex flex-row-reverse">
    ...
    <div class="auth-right py-40 px-24 flex-center flex-column" dir="rtl">
        <div class="auth-right__inner mx-auto w-100" style="max-width: 440px;">
            ...
            <form action="<?= UtilityHelper::baseUrl('user/login'); ?>" method="post" class="text-end">
                <?= csrf_field(); ?>
                <div class="mb-24">
                    <label for="email" class="form-label mb-8 h6">ایمیل یا نام کاربری</label>
                    <div class="position-relative">
                        <input type="text" name="email" class="form-control py-11 ps-40" id="email" placeholder="example@domain.com" value="<?= htmlspecialchars(old('email', $oldInput['email'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" required>
                ...
                <div class="mb-32 flex-between flex-wrap gap-8">
                    ...
                    <a href="<?= UtilityHelper::baseUrl('user/password/forgot'); ?>" class="text-main-600 hover-text-decoration-underline text-15 fw-medium">فراموشی رمز عبور</a>
                </div>
...
<?php
include __DIR__ . '/../../layouts/home-login-footer.php';
